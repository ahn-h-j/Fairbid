    ...
    public void 경매_종료_처리를_실행한다() {
        ...
        jpaAuctionRepository.saveAndFlush(
                AuctionEntity.builder()
                        ...
                        .winnerId(null)
                        .directTradeAvailable(auctionEntity.getDirectTradeAvailable())
                        .deliveryAvailable(auctionEntity.getDeliveryAvailable())
                        .directTradeLocation(auctionEntity.getDirectTradeLocation())
